...
func NewApp(shutdown chan os.Signal, tracer trace.Tracer, mw ...Middleware) *App {
	// Create an OpenTelemetry HTTP handler which wraps our router. This will start the
...
// tracing. The opentelementry mux then calls the application mux to handle
// application traffic.
